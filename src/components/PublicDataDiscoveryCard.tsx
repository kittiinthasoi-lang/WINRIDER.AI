...
export const PublicDataDiscoveryCard:React.FC = () => {
  ...
  return <section className="rounded-3xl border border-cyan-400/15 bg-[#08152E] p-4 shadow-lg">
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div><div className="flex items-center gap-2"><MapPin className="h-4 w-4 text-cyan-300"/><h2 className="text-sm font-black text-white">ข้อมูลสาธารณะประเทศไทย</h2><span className="rounded-full border border-emerald-400/30 bg-emerald-400/10 px-2 py-0.5 text-[8px] font-black text-emerald-300">FREE • VERIFIED</span></div><p className="mt-1 text-[9px] text-slate-500">ข้อมูลสาธารณะที่แอดมินตรวจแล้ว • ใช้ได้กับทุกบทบาท</p></div>
