...
export const GoogleMapsNavigationScreen: React.FC<NavigationProps> = ({
  ...
  driverName = 'พี่วินสมชาย รักเกียรติ (LV.38)',
  driverAvatar = '🛵',
  driverPlate = '1กข 7789 กทม.',
  driverVehicle = 'Honda Forza 350',
  driverPhone = '089-123-4567',
  passengerName = 'คุณอารียา สุขสวัสดิ์',
  pickupAddress = 'ซอยสุขุมวิท 39 (หน้า EmQuartier & BTS พร้อมพงษ์)',
  pickupCoords = { lat: 13.7314, lng: 100.5700 },
  dropoffAddress = 'สยามพารากอน - สยามสแควร์วัน (ถนนพระราม 1)',
  dropoffCoords = { lat: 13.7462, lng: 100.5348 },
  fareBaht = 55,
  audioEnabled = true,
  onArrivedAtPickup,
  onArrivedAtDropoff,
