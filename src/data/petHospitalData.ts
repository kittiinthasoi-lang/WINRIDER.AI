export interface PetHospitalClinic {
  ...
  routeSource: 'straight_line_estimate' | null;
}
...
export const WIN_PET_CARE_REQUIREMENTS = {
  ...
  serviceHighlights: [
    ...
    'ระยะทางและเวลาเดินทางต้องระบุแหล่งที่มาอย่างชัดเจน; ขณะนี้ใช้ระยะเส้นตรงประมาณการเพราะ Google Routes ปิดชั่วคราว',
  ],
};
